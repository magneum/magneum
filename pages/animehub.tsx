...
var crons = await axios.get(`/api/animehub?title=${userInput.current.value}`);
...
<>
<Head>
<title>Magneum 🍀 AnimeHub</title>
<meta name="description" content="made with Love using Nextjs and tailwindcss" />
...
to animation produced in Japan.<br></br>
...
Japan.However, in Japan and in Japanese, anime describes
all animated works, regardless of style or origin.
</p>
</h5>
