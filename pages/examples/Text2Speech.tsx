...
const code_1 = `// ?q=  is the querry that api/text2speech takes
...
const code_2 = `// ?q=  is the querry that api/text2speech takes
...
const code_3 = `// ?q=  is the querry that api/text2speech takes
