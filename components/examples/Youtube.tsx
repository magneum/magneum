...
axios.get("https://magneum.vercel.app/api/youtube?q=ncs 2min song")
...
request({
method: "GET",
url: "https://magneum.vercel.app/api/youtube?q=ncs 2min song",
headers: {
...
unirest.post("https://magneum.vercel.app/api/youtube?q=ncs 2min song")
