...
// Method 1 (Axios)
axios.get("https://magneum-api.vercel.app/api/anime?q=death note")
...
request({
method: "GET",
url: "https://magneum-api.vercel.app/api/anime?q=death note",
headers: {
...
// Method 3 (Unirest)
unirest.post("https://magneum-api.vercel.app/api/anime?q=death note")
    ...
    <div>
      ...
      >
        ...
        <div className="collapse-content text-gray-400">
          <p>
            endpoint:{" "}
            <span className="italic text-blue-300">/api/anime?q=</span>
            <br></br>
            example: /api/anime?q=
