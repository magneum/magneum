...
const code_1 = `// ?q=  is the querry that api/animation takes
...
const code_2 = `// ?q=  is the querry that api/animation takes
...
const code_3 = `// ?q=  is the querry that api/animation takes
