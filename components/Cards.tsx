...
<h2 className="mb-6 text-3xl font-bold tracking-wide text-lime-400/70 capitalize font-serif sm:text-4xl sm:leading-none">
% {TypeHead}
</h2>
...
YouTube, Spotify in HD quality. Available formats are .webm
.mp4. You can easily download for free thousands of videos from
YouTube and other websites. Once the required video url or song
name is provided, all the meta informations are shown in the
page.
</p>
<a
href="/premiumdl"
...
<div className="overflow-hidden transition-shadow duration-300 bg-[#222522] rounded-2xl shadow-2xl xl:hover:scale-105 lg:hover:scale-105 md:hover:scale-105 hover:shadow-2xl hover:shadow-lime-600">
<img src="/node.gif" className="object-cover w-full h-64" alt="" />
<div className="p-5">
<p className="mb-3 text-xs font-semibold tracking-wide uppercase">
<a
...
<p className="mb-3 text-xs font-semibold tracking-wide uppercase">
<a
href="https://vlkyre.up.railway.app/vlkyre.html"
className="transition-colors duration-200 text-blue-gray-900 hover:text-lime-700"
aria-label="Category"
title="traveling"
>
...
<div className="overflow-hidden transition-shadow duration-300 bg-[#222522] rounded-2xl shadow-2xl xl:hover:scale-105 lg:hover:scale-105 md:hover:scale-105 hover:shadow-2xl hover:shadow-lime-600">
<img src="/anime.gif" className="object-cover w-full h-64" alt="" />
<div className="p-5">
<p className="mb-3 text-xs font-semibold tracking-wide uppercase">
<a
href="/animehub"
...
and in Japanese, anime describes all animated works, regardless
of style or origin.
</p>
<a
href="/animehub"
