      ...
      <div className="items-center justify-center text-xl">
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-1 lg:py-20">
          <div className="grid gap-8 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full">
            <div className="overflow-hidden transition-shadow duration-300 bg-[#282828] rounded-2xl shadow-2xl hover:scale-105 hover:shadow-2xl hover:shadow-purple-600">
              <Image
                width={800}
                height={800}
                src="/github.gif"
